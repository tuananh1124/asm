...
.app-links a img, .social-links a img {
	width: 40px;
	margin-right: 10px;
}
 ...
 <footer class="footer">
        <div class="footer-container">
            <div class="footer-column">
                ...
                <h4>Phương thức thanh toán</h4><img src="payment_methods.png" alt="Phương thức thanh toán">
            </div>
            <div class="footer-column">
                <h3>Đăng ký nhận tin khuyến mãi</h3>
                <p><strong>Nhận ngay voucher 10%</strong></p>
                <p><em>Voucher sẽ được gửi sau 24h, chỉ áp dụng cho khách hàng mới</em></p>
                <form>
                    <input type="email" placeholder="Email *" required>
                    <input type="tel" placeholder="Số điện thoại">
                    <div class="checkbox-container">
                        <input type="checkbox" id="terms" required>
                        <label for="terms">Tôi đồng ý với điều khoản của CellphoneS</label>
                    </div>
        ...
        <div class="footer-bottom">
            <p>© 2024 Công ty TNHH Thương Mại và Dịch Vụ Kỹ Thuật ĐIỆU PHÚC. GPDKKD: 0316172372 cấp tại Sở KH & ĐT TP. HCM. Địa chỉ văn phòng: 350-352 Võ Văn Kiệt, Phường Cô Giang, Quận 1, Thành phố Hồ Chí Minh, Việt Nam. Điện thoại: 028.7108.9666.</p>
        </div>
    </footer>
